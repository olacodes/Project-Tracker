      ...
      <div class=" d-md-flex shadow justify-content-between text-justify p-4">
          ...
          <div class="card-content p-4">
               <div class="content-text">
                   <h4 class="content-header pb-2 has-text-weight-semibold is-size-4"> Intro to Project Manager</h4>
                   <p class="pr-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Phasellus nec iaculis mauris hj tgus tgab ege naru ckys care are argyabke giisd basb.</p>
                    <br>
